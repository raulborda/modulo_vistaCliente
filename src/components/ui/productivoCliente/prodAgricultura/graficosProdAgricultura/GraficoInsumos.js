...
export const GraficoInsumos = () => {
  ...
  for (let i = 0; i < isDataInsumoTotal.length; i++) {
    entregadasArray.push(parseInt(isDataInsumoTotal[i].Compra));
    encuestaArray.push(parseInt(isDataInsumoTotal[i].Estimado));
  }
    ...
    <>
      ...
      <div className="div_grafico_insumos">
        ...
        {isLoading > 0 ? (
          ...
          <ResponsiveContainer className="GrafInsumo" width="99%" height={230}>
            <ComposedChart
              height={250}
              data={
                activeKey === "1"
